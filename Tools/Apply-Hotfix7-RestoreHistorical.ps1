...
'1.0.18-hotfix7-restore' | Set-Content (Join-Path $InstallDir 'version.txt') -Encoding UTF8
Write-Host 'hotfix7-restore deploye : comportement planning v1.0.18 restaure' -ForegroundColor Green
